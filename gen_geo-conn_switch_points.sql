...
SELECT 0, g1.vertex_id, g2.vertex_id, 11, 12, 92, 0.5, 't', g1.raw_point_id FROM
...
UPDATE switch_points SET switch_point_id=(92 || id::text)::bigint WHERE switch_point_id=0;
