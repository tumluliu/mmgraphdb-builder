...
SELECT 0, (15 || g1.nn_gid::text)::bigint, (12 || g2.nn_gid::text)::bigint, 15, 12, 96, 0, 't', g1.type_id FROM
...
INSERT INTO switch_points (switch_point_id, from_vertex_id, to_vertex_id, from_mode_id, to_mode_id, type_id, cost, is_available, ref_poi_id)
SELECT 0, (12 || g1.nn_gid::text)::bigint, (15 || g2.nn_gid::text)::bigint, 12, 15, 96, 5, 't', g1.type_id FROM
